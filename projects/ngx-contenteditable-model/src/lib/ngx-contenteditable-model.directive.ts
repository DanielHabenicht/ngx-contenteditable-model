import {
    ...
    HostListener, Sanitizer, SecurityContext, TemplateRef, ViewContainerRef, NgZone
} from '@angular/core';
...
export class ContenteditableDirective implements OnChanges {
    /** Model */
    @Input() public contenteditableModel: string;
    @Output() public contenteditableModelChange = new EventEmitter();
    /** Allow (sanitized) html */
    @Input() public contenteditableHtml = false;
    private bound = false;
    ...
    @HostListener('keyup') public onInput(trim = false) {
    ...
    @HostListener('paste') public onPaste() {
        this.onInput();
